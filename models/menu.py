...
response.meta.description = 'Arachnolingua bridge database administration tool'
response.meta.keywords = 'web2py, python, framework, arachnolingua'
...
def _():
    ...
    response.menu += [
        (SPAN('web2py', _class='highlighted'),
         False,
         'http://web2py.com',
         [(T('My Sites'),
           False,
           URL('admin', 'default', 'site')),
          (T('This App'),
           False,
           ...
           [(T('Controller'),
            ...
            (T('Stylesheet'),
             ...
             URL('admin',
                 'default',
                 'edit/%s/static/css/web2py.css' % app)),
            (T('DB Model'),
             False,
             URL('admin',
                 'default',
            ...
            (T('Errors'),
             False,
             URL('admin', 'default', 'errors/' + app)),
            (T('About'),
             False,
             URL('admin', 'default', 'about/' + app))
            ]),
          ('web2py.com',
           False,
           'http://www.web2py.com',
